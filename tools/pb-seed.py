#!/usr/bin/env python3
"""
Seed church_pages + church_animations with the existing book content.
Idempotent: looks up existing record by (book_index, side) and updates if found.
...
PAGES = [
    # sheet 0 — Cover + intro
    dict(order=0,  book_index=0, side="front", label="Ἐξώφυλλο",
         eyebrow="", title="Ι.Ν.\nἉγίου\nἈνδρέου",       date="",
         lead="", body="Ὁ καθεδρικὸς τῶν Πατρῶν · τὸ χρονικὸ ἀνεγέρσεως",
         photo_title="", photo_cap="", photo_desc="", photo_italic=""),

    dict(order=1,  book_index=0, side="back",  label="Πρόλογος",
    ...
    dict(order=2,  book_index=1, side="front", label="Περιεχόμενα",
         eyebrow="Περιεχόμενα", title="Τὸ Χρονικὸ\nτῆς Ἀνεγέρσεως", date="",
         lead="", body="", photo_title="", photo_cap="", photo_desc="", photo_italic=""),

    dict(order=3,  book_index=1, side="back",  label="α´ Μελέτη",
    ...
    dict(order=4,  book_index=2, side="front", label="α´ Ἀντιδράσεις",
    ...
    dict(order=5,  book_index=2, side="back",  label="β´ Θεμέλιος λίθος",
    ...
    dict(order=6,  book_index=3, side="front", label="β´ Διακοπές",
    ...
    dict(order=7,  book_index=3, side="back",  label="γ´ Ἀνοικοδόμησις",
    ...
    dict(order=8,  book_index=4, side="front", label="δ´ Ἐγκαίνια",
    ...
    dict(order=9,  book_index=4, side="back",  label="δ´ Ἐσωτερικός",
    ...
    dict(order=10, book_index=5, side="front", label="ε´ Στοιχεῖα",
    ...
    dict(order=11, book_index=5, side="back",  label="ϛ´ Ὁ Σταυρός",
    ...
    dict(order=12, book_index=6, side="front", label="ζ´ Χρυσόστομος",
    ...
    dict(order=13, book_index=6, side="back",  label="ζ´ Ἀνακαινίσεις",
    ...
    dict(order=14, book_index=7, side="front", label="τέλος",
    ...
    dict(order=15, book_index=7, side="back",  label="Ὀπισθόφυλλο",
